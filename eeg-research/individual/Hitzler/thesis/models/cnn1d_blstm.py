...
class CNN1D_BLSTM(nn.Module):
    def __init__(self, args: dict, device):
        ...
        self.lstm = nn.LSTM(
            ...
            num_layers=args["num_layers"],  # Changed from args.num_layers to args["num_layers"]
            batch_first=True,
        ...
        self.classifier = nn.Sequential(
            ...
            nn.BatchNorm1d(64),
            self.activations[activation],
            nn.Linear(in_features=64, out_features=1, bias=True),  # Changed from args.output_dim to args["output_dim"]
        )
