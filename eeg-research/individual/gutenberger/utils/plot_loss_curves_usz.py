...
# Define file paths
file_paths = [
    "Jan30_13-57-02/wandb_export_2025-02-15T16_31_14.502+01_00_train.csv", 
    "Jan30_13-57-02/wandb_export_2025-02-15T16_31_08.122+01_00_val.csv"
]
file_path = 'C:/Users/mgute/OneDrive/Dokumente/A_Universität/JKU/AI_Master/A_EEG/Master_Thesis_AI/wandb_training_curves'
output_dir = os.path.join(file_path, 'Jan30_13-57-02', "plots")
os.makedirs(output_dir, exist_ok=True)  # Create the directory if it doesn't exist
save_name = 'usz_loss_curves_plot'
