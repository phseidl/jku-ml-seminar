...
filenames = ['metrics_summary_upt4eeg_small_tuh.csv', 
             'metrics_summary_upt4eeg_small_rdm_cd_same.csv', 
             'metrics_summary_upt4eeg_small_rdm_cd.csv', 
             'metrics_summary_upt4eeg_small_rdm.csv', 
             'metrics_summary_upt4eeg_CLEAN-B0_montage_tuh.csv',
             'metrics_summary_upt4eeg_CLEAN-B1_montage_tuh.csv',
             'metrics_summary_upt4eeg_CLEAN-B2_montage_tuh.csv',
             'metrics_summary_upt4eeg_CLEAN-B3_montage_tuh.csv',
             'metrics_summary_upt4eeg_CLEAN-B4_montage_tuh.csv',
             'metrics_summary_upt4eeg_CLEAN-E1_montage_tuh.csv',
             'metrics_summary_upt4eeg_CLEAN-E2_montage_tuh.csv',
             'metrics_summary_upt4eeg_CLEAN-E3_montage_tuh.csv',
             'metrics_summary_upt4eeg_CLEAN-E4_montage_tuh.csv',] 
row_names = ['CLEAN0', 
             'CLEAN1', 
             'CLEAN2', 
             'CLEAN3', 
...
save_name = 'latex_table_tuh.txt'
table_label = 'performance_comp_hyperparams_tuh'
caption = '{Comparison of CLEAN model performance across all test subjects using the fixed TCP montage as input.}'
